...
<?php include 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>BOOKS MASTER DATA</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="">Books</a></li>
          <li class="breadcrumb-item active">BOOK MASTER DATA</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  <label for="inputPassword5" class="form-label">Initial Stocks</label>
                  <input type="text" placeholder="Initial Stocks" required name="initialstock" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="11" class="form-control" id="inputPassword5">
                </div>
                ...
                <div class="">
                  <button type="submit" class="btn btn-primary" name="onadd_items">Save Inventory</button>
                </div>
                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Initial Stocks</th>
                    ...
                    <?php 
                      $query = "SELECT A.id,A.itemname,A.category,A.initialstock,A.file  FROM tbl_inventory A";
                            ...
                            <div class="modal-body">
                              <div class="card">
                                <div class="card-body"> 
                                  ...
                                  <br>
                              <!-- Multi Columns Form -->
                              <form class="row g-3" method="POST" action="php/edit_items.php">
                                ...
                                <div class="col-md-12">
                                  <label for="inputPassword5" class="form-label">Initial Stocks</label>
                                  <input type="text" placeholder="Initial Stocks" required name="initialstock" onkeypress="return event.charCode >= 48 && event.charCode <= 57" value="<?php echo $initialstock;?>" maxlength="11" class="form-control" id="inputPassword5">
                                </div>
