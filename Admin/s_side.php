 ...
 <!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar" style="background-color:rgb(0, 39, 76)">
    ...
    <ul class="sidebar-nav" id="sidebar-nav" style="background-color:rgb(0, 39, 76)">
      ...
      <li class="nav-item" >
        <a class="nav-link " href="student_dash.php" style="background-color:rgb(0, 39, 76)">
      ...
      <li class="nav-item">
        <a class="nav-link " href="borrow_books.php" style="background-color:rgb(0, 39, 76)">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link " href="s_borrow.php" style="background-color:rgb(0, 39, 76)">
          <i class="bi bi-files" style="color:#ffb31a"></i>
          <span style="color:#ffb31a;">Borrowing Records<span class="badge bg-danger"></span></span>
        </a>
      </li>
      '
;
