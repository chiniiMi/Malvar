        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-header" style="background-color:rgb(0, 39, 76)">
                  <h5 class="card-title" style="color:white;">EVENTS <span>| Information</span></h5>
            </div>
            <div class="card-body">
                    <!-- Multi Columns Form -->
                    <?php 

                             if (isset($_POST['onadd_events'])){
                                onadd_events($_POST);
                             }
                 ...
                 <form class="row g-3" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    ...
                    <input type="date" required name="eventdate" placeholder="Event Date" class="form-control" id="inputName5">
                  </div>
                ...
                <div class="">
                  <button type="submit" class="btn btn-primary" name="onadd_events">ADD</button>
                </div>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <td><span class="badge bg-success"><?php echo $eventdate; ?></span></td>
                        <td>
                            <a class="btn btn-danger" href="php/delete_events.php?id=<?php echo $id; ?>"> <i class="bi bi-trash-fill"></i></a></td>
                      </tr>
